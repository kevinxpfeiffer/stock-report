...
'''Get Data'''
stock_prices = gd.stock_prices[['4. close']]
ticker = stock_prices[::-1]  # reverse dataframe for better calculation

'''

Calculate Technical Indikators:
    - Williams' %R
    - CCI
    - on balance volume
    -ADX
...
- Eigenkapitalqoute = Eigenkapital / Bilanzsumme => Nicht unter 25 %
- Gearing = (Schulden - Cash) / Eigenkapital => je niedriger desto besser
- Marktkapitalisierung = Anzahl der Aktien * Kurs
- Unternehmenswert = Marktkapitalisierung + Fremdkapital - liquide Mittel
- Unternehmenswert / Umsatz => geringer als bei Konkurrent unterbewertet
=> Noch mal nach Kennzahlen googeln
